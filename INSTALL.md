...
```console
pip install test-pypi-linux-py39-test
```
...
```console
pip install git+ssh://git@github.com/whiteprints-tests/test-pypi-linux-py39-test
```
...
[package]: https://pypi.org/project/test-pypi-linux-py39-test
